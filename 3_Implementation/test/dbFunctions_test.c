...
void test_add_contact(void) {
    ...
    entryFormat new_entry = {256000, 8318331989, 30000, 2021, "Debarpan"};
...
void test_modify_contact(void) {
    FILE* file = fopen(loc, "wb+"); 
    entryFormat new_entry1 = {256000, 8318331989, 30000, 2021, "Debarpan"};
    entryFormat new_entry2 = {256001, 8318331988, 30001, 2021, "Gariman"};
